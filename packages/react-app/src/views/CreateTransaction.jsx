    ...
    try {
      ...
      if(newSignaturesRequired<1){
        ...
        if (methodName == "transferFunds" || methodName == "customCallData") {
          ...
          executeToAddress = to;
        } else if(methodName == "safeMint"){
          callData = readContracts["BabyGhost"]?.interface?.encodeFunctionData(methodName, [to]);
          executeToAddress = nftContractAddress;
        }else {
        ...
        <div style={{ margin: 8 }}>
          <div style={{ margin: 8, padding: 8 }}>
            <Select value={methodName} style={{ width: "100%" }} onChange={setMethodName}>
              ...
              <Option key="safeMint">Buy Ghost NFT 👻</Option>
